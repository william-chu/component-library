      ...
      <div class="menu-fade-grid">
        <a href="<?php echo $data['menu_link1']; ?>">
          <div class="menu-fade-item">
            ...
            <img class="menu-fade-icon" src="http://componentlibrary.blogdrop.eu/wp-content/uploads/2018/09/placemarker.png" alt="placemarker icon" />
          </div>
        </a>
        <a href="<?php echo $data['menu_link2']; ?>">
          <div class="menu-fade-item">
            ...
            <img class="menu-fade-icon" src="http://componentlibrary.blogdrop.eu/wp-content/uploads/2018/09/health.png" alt="clinic icon" />
          </div>
        </a>
        <a href="<?php echo $data['menu_link3']; ?>">
          <div class="menu-fade-item">
            ...
            <img class="menu-fade-icon" src="http://componentlibrary.blogdrop.eu/wp-content/uploads/2018/09/calendar.png" alt="calendar icon" />
          </div>
        </a>
      </div>
    </div>
